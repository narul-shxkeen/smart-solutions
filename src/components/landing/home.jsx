...
function Home() {    
    return (
        <div>
            <img src="images/landingImage.png" alt="Landing Image" className="absolute h-[70vh] w-auto sm:w-full sm:h-[90vh] object-cover -z-20"/>
            ...
            <img src="images/Line 1.png" alt="a blue line which underlines the company's name" className="absolute hidden lg:block lg:top-[40%] lg:left-[42.7%]"/>
            ...
            <div className="-z-10 h-10 w-48 sm:h-16 sm:w-72 relative bottom-[70px] sm:bottom-[83px] left-[3px] rounded-full ml-0 pl-0 pt-0" style={{ background: 'linear-gradient(93.28deg, #00A7E1 23.14%, #FFA630 87.83%)' }}>
            </div>
            </div>
        </div>
    );
