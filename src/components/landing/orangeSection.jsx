...
<p className="poppins-regular text-xs sm:text-base text-justify md:text-center px-10">
...
<div className="">
        <Link to="/about" className="relative z-20 bg-white h-10 w-48 sm:h-10 sm:w-48 poppins-medium rounded-full mt-0 flex justify-center items-center text-xs sm:text-lg shadow-lg">Know More</Link>
