...
function ServicesMini(){
    return <div className="flex flex-col gap-3 pt-5 md:pt-8 items-center justify-center bg-[#F7F0F0]">
        ...
        <div className="">
        <Link to="/contact" className="relative z-20 bg-white h-10 w-48 sm:h-10 sm:w-48 poppins-medium rounded-full mt-0 flex justify-center items-center text-xs sm:text-lg shadow-lg">Explore More</Link>
