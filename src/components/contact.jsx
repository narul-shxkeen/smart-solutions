  ...
  const handleSubmit = async (e) => {
    ...
    return <div className="flex flex-col md:flex-row bg-[#F7F0F0] justify-center items-center gap-10 md:gap-20 py-10 md:py-20">
      <div className="flex flex-col gap-6 md:gap-10 w-full md:w-2/5 px-4">
        ...
        <p className="text-sm md:text-base poppins-regular w-full md:w-2/3">Looking for custom print designs for your business? Fill out the form below with your message, and we’ll be delighted to answer any questions you may have. We’ll get back to you soon!</p>
        <p className="text-sm md:text-base poppins-regular">Alternatively, you can reach out to us at following:</p>

<p className="text-sm md:text-base poppins-regular">Email: <span className="text-[#00A7E1]">smartsolutionsprintnpack@gmail.com</span></p>
<p className="text-sm md:text-base poppins-regular">Phone: <span className="text-[#00A7E1]">9810018313</span> </p>
