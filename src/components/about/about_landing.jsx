...
function Landing(){
    return <div className="flex flex-col-reverse md:flex-row gap-8 bg-[#37393A] ">
        ...
        <p className="text-white poppins-regular text-sm sm:text-lg z-20">Welcome to Smart Solutions Print N Pack, a distinguished leader in the printing and advertising materials industry, proudly serving from vibrant Mayapuri Industrial Area, Phase 1, for<span className="gradient-text"> over 30 years</span>. Our mission is to provide our esteemed clients with the best-adapted and innovative substrate solutions for all their advertising and packaging needs.
